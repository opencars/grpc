...
func (c *serviceClient) Decode(ctx context.Context, in *DecodeRequest, opts ...grpc.CallOption) (*DecodeResultList, error) {
	out := new(DecodeResultList)
	err := c.cc.Invoke(ctx, "/koatuu.Service/Decode", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Service_Decode_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/koatuu.Service/Decode",
	}
...
var Service_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "proto/koatuu/operation.proto",
}
