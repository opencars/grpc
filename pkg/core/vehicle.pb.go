...
var file_proto_core_vehicle_proto_rawDesc = []byte{
	...
	0x0a, 0x6f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0x33, 0x0a, 0x06, 0x52,
	0x65, 0x73, 0x75, 0x6c, 0x74, 0x12, 0x29, 0x0a, 0x08, 0x76, 0x65, 0x68, 0x69, 0x63, 0x6c, 0x65,
	0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0d, 0x2e, 0x63, 0x6f, 0x72, 0x65, 0x2e, 0x56,
...
var file_proto_core_vehicle_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_proto_core_vehicle_proto_goTypes = []interface{}{
	...
	(*registration.Record)(nil), // 5: registration.Record
	(*operation.Record)(nil),    // 6: operation.Record
}
var file_proto_core_vehicle_proto_depIdxs = []int32{
	4, // 0: core.Vehicle.first_reg_date:type_name -> common.Date
	5, // 1: core.Vehicle.registrations:type_name -> registration.Record
	6, // 2: core.Vehicle.operations:type_name -> operation.Record
	2, // 3: core.Result.vehicles:type_name -> core.Vehicle
	0, // 4: core.VehicleService.FindByNumber:input_type -> core.NumberRequest
	1, // 5: core.VehicleService.FindByVIN:input_type -> core.VINRequest
	3, // 6: core.VehicleService.FindByNumber:output_type -> core.Result
	3, // 7: core.VehicleService.FindByVIN:output_type -> core.Result
