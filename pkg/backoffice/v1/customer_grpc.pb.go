...
func (c *customerServiceClient) FindById(ctx context.Context, in *FindByIdRequest, opts ...grpc.CallOption) (*FindByIdResponse, error) {
	out := new(FindByIdResponse)
	err := c.cc.Invoke(ctx, "/backoffice.v1.CustomerService/FindById", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedCustomerServiceServer) FindById(context.Context, *FindByIdRequest) (*FindByIdResponse, error) {
...
func _CustomerService_FindById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/backoffice.v1.CustomerService/FindById",
	}
...
var CustomerService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "backoffice.v1.CustomerService",
	...
	Metadata: "backoffice/v1/customer.proto",
}
